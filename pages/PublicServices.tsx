...
import { CarteProjecteur, Feuille, KenBurns, Reveal, TexteRevele, useLenis } from '../components/motion';
...
const TEXTES = {
  FR: {
    ...
    buy: 'Acheter',
    onRequestBtn: 'Sur demande',
    merciTexte: 'Merci, votre paiement est confirmé. Laurie vous écrit sous peu.',
    erreurPaiement: "Le paiement n'a pas pu démarrer. Réessayez dans un instant.",
  ...
  EN: {
    ...
    subscribe: 'Subscribe',
    buy: 'Buy',
    onRequestBtn: 'On request',
    merciTexte: "Thank you, your payment is confirmed. Laurie will write to you shortly.",
    erreurPaiement: 'Payment could not start. Try again in a moment.',
