...
const TEXTES = {
  FR: {
    ...
    pourquoiTitre: 'À quoi ça sert, et qui peut voir quoi',
    ...
    pourquoi2: 'Ce que vous écrivez ici est chiffré dans votre navigateur avant de partir : une clé unique verrouille le contenu (AES-256-GCM), puis cette clé se scelle avec la clé publique d\'Alex (RSA-4096). Seule sa moitié privée, gardée sur son ordinateur, ouvre le tout. Ni Firestore, ni Google, ni le site, ni un autre compte admin ne peuvent lire ce que vous avez déposé, carte comme spécimen de chèque.',
    pourquoi3: 'Ce qui reste lisible, pour que vous voyiez ce que vous avez déposé sans tout rouvrir : le nom sur la carte, ses quatre derniers chiffres et sa date d\'expiration. Le reste, y compris le spécimen de chèque, ne se déchiffre que sur l\'ordinateur d\'Alex. Vous voyez ci-dessous la date où il l\'a lu, et vous pouvez tout effacer d\'ici, à tout moment.',
    ...
    banqueTitre: 'Pour vous payer',
    banqueIntro: 'Ce qu\'il faut à Alex pour vous verser un paiement par virement. Chiffré comme le reste, spécimen de chèque compris.',
    titulaireCompte: 'Nom du titulaire du compte',
    institution: 'Institution',
    transit: 'Numéro de transit',
    numeroCompte: 'Numéro de compte',
    specimenLabel: 'Spécimen de chèque',
    specimenAide: 'Photo ou PDF, 10 Mo maximum. Chiffré avant l\'envoi, comme le reste du coffre.',
    specimenDepose: 'Un fichier est prêt à envoyer :',
    specimenRetirer: 'Retirer',
    erreurSpecimenTaille: 'Ce fichier dépasse 10 Mo.',
    erreurSpecimenType: 'Une photo (JPEG, PNG, WebP) ou un PDF seulement.',
    specimenStatut: 'Spécimen de chèque déposé',
  ...
  EN: {
    ...
    pourquoiTitre: 'What it is for, and who can see what',
    ...
    pourquoi2: 'What you write here is encrypted in your browser before it leaves: a one-time key locks the content (AES-256-GCM), then that key is sealed with Alex\'s public key (RSA-4096). Only his private half, kept on his computer, opens it. Neither Firestore, nor Google, nor the site, nor another admin account can read what you deposited, card or void cheque alike.',
    pourquoi3: 'What stays readable, so you can see what you deposited without opening it all back up: the name on the card, its last four digits and its expiry date. Everything else, the void cheque included, only decrypts on Alex\'s computer. You can see below when he read it, and you can clear everything from here, at any time.',
    ...
    banqueTitre: 'To pay you',
    banqueIntro: 'What Alex needs to send you a payment by transfer. Encrypted like everything else, void cheque included.',
    titulaireCompte: 'Name on the account',
    institution: 'Institution',
    transit: 'Transit number',
    numeroCompte: 'Account number',
    specimenLabel: 'Void cheque',
    specimenAide: 'Photo or PDF, 10 MB max. Encrypted before it leaves, like the rest of the vault.',
    specimenDepose: 'A file is ready to send:',
    specimenRetirer: 'Remove',
    erreurSpecimenTaille: 'This file is over 10 MB.',
    erreurSpecimenType: 'A photo (JPEG, PNG, WebP) or a PDF only.',
    specimenStatut: 'Void cheque on file',
