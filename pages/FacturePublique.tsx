...
const EXEMPLE_VERIF: FacturePubliqueDoc = {
  ...
  items: [
    ...
    { id: '3', description: 'Atelier positionnement de marque', quantity: 2, price: 150 },
    { id: '4', description: 'Séance de coaching individuel', quantity: 4, price: 120 },
    { id: '5', description: 'Relecture du dossier de presse', quantity: 1, price: 200 },
    { id: '6', description: 'Coordination avec les diffuseurs', quantity: 3, price: 95 },
    { id: '7', description: 'Rédaction infolettre mensuelle', quantity: 2, price: 110 },
    { id: '8', description: 'Suivi des réseaux sociaux', quantity: 4, price: 80 },
    { id: '9', description: 'Préparation entrevue médias', quantity: 1, price: 175 },
    { id: '10', description: 'Révision du site web', quantity: 2, price: 140 },
    { id: '11', description: 'Accompagnement subvention', quantity: 3, price: 160 },
    { id: '12', description: 'Rencontre de suivi trimestrielle', quantity: 1, price: 200 },
    { id: '13', description: 'Rédaction communiqué de presse', quantity: 2, price: 130 },
    { id: '14', description: 'Coordination tournée régionale', quantity: 3, price: 150 },
    { id: '15', description: 'Bilan annuel et recommandations', quantity: 1, price: 250 },
  ],
