...
const TEXTES = {
  FR: {
    ...
    confirmEnvoi: (qui: string) => `Envoyer cette infolettre maintenant à ${qui} ? Cette action est irréversible.`,
    promptTest: 'Adresse courriel pour le test :',
    testEnvoye: (e: string) => `Test envoyé à ${e}.`,
    envoyeeA: (n: number) => `Envoyée à ${n} personne(s).`,
  ...
  EN: {
    ...
    confirmEnvoi: (qui: string) => `Send this newsletter now to ${qui}? This is irreversible.`,
    promptTest: 'Email address for the test:',
    testEnvoye: (e: string) => `Test sent to ${e}.`,
    envoyeeA: (n: number) => `Sent to ${n} people.`,
