...
interface EtatErreurTest {
  aPlante: boolean;
}

export class ErreurRacineTest extends React.Component<React.PropsWithChildren, EtatErreurTest> {
  state: EtatErreurTest = { aPlante: false };

  static getDerivedStateFromError(): EtatErreurTest {
    return { aPlante: true };
  }
  ...
  componentDidCatch(erreur: unknown) {
    ...
    console.error('[ErreurRacineTest]', erreur);
  }
...
export default ErreurRacineTest;
